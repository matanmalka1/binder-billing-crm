...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "due_day_of_month BETWEEN 1 AND 31", name="ck_deadline_rule_due_day_range"
        ),
        sa.CheckConstraint(
        ...
        sa.CheckConstraint(
            "offset_months >= 0", name="ck_deadline_rule_offset_months_non_negative"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "idx_deadline_rule_type_effective",
        "deadline_rules",
        ["rule_type", "effective_from"],
        unique=False,
    )
    op.create_index(
        op.f("ix_deadline_rules_rule_type"),
        "deadline_rules",
        ["rule_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "id_number_type",
            sa.Enum(
                "individual", "corporation", "passport", "other", name="idnumbertype"
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            ...
            sa.Enum("monthly", "bimonthly", name="advance_payment_frequency"),
            nullable=True,
        ),
        sa.Column(
            "vat_exempt_ceiling", sa.Numeric(precision=12, scale=0), nullable=True
        ),
    ...
    op.create_index(
        "ix_legal_entities_official_name",
        "legal_entities",
        ["official_name"],
        unique=False,
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "id_number_type", "id_number", name="uq_person_identity_id"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("scheduled", "fired", "canceled", "failed", name="reminderstatus"),
            nullable=False,
        ),
        sa.Column(
            "action_type",
    ...
    op.create_index(
        "idx_reminders_status_fire_at", "reminders", ["status", "fire_at"], unique=False
    )
    op.create_index(
        op.f("ix_reminders_fire_at"), "reminders", ["fire_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("advisor", "secretary", name="userrole"), nullable=False
        ),
    ...
    op.create_index(
        ...
        "businesses",
        ["legal_entity_id", "business_name"],
        unique=True,
        postgresql_where=sa.text("business_name IS NOT NULL AND deleted_at IS NULL"),
        sqlite_where=sa.text("business_name IS NOT NULL AND deleted_at IS NULL"),
    )
    op.create_index("ix_business_status", "businesses", ["status"], unique=False)
    op.create_index(
        op.f("ix_businesses_legal_entity_id"),
        "businesses",
        ["legal_entity_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_client_records_accountant_id"),
        "client_records",
        ["accountant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_client_records_legal_entity_id"),
        "client_records",
        ["legal_entity_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_entity_audit_logs_entity_id"),
        "entity_audit_logs",
        ["entity_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_entity_audit_logs_entity_type"),
        "entity_audit_logs",
        ["entity_type"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_entity_notes_type_id",
        "entity_notes",
        ["entity_type", "entity_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_entity_notes_entity_id"), "entity_notes", ["entity_id"], unique=False
    )
    op.create_index(
        op.f("ix_entity_notes_entity_type"),
        "entity_notes",
        ["entity_type"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_person_legal_entity_links_legal_entity_id",
        "person_legal_entity_links",
        ["legal_entity_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("open", "done", "canceled", name="taskstatus"),
            nullable=False,
        ),
        sa.Column(
            "priority",
    ...
    op.create_index(
        "idx_tasks_assigned_to_user_id", "tasks", ["assigned_to_user_id"], unique=False
    )
    ...
    op.create_index(
        "idx_tasks_source", "tasks", ["source_domain", "source_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.CheckConstraint(
            "(obligation_type = 'annual_report' AND period IS NULL) OR (obligation_type <> 'annual_report' AND period IS NOT NULL)",
            name="ck_tax_calendar_entry_period_nullability",
        ),
        sa.CheckConstraint(
            "(obligation_type = 'annual_report' AND period_months_count IS NULL) OR (obligation_type <> 'annual_report'     AND period_months_count IN (1, 2))",
    ...
    op.create_table(
        ...
        sa.Column("email", sa.String(), nullable=True),
        sa.Column(
            "status", sa.Enum("success", "failure", name="auditstatus"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_user_audit_logs_action"), "user_audit_logs", ["action"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_user_audit_logs_created_at"),
        "user_audit_logs",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_audit_logs_email"), "user_audit_logs", ["email"], unique=False
    )
    op.create_index(
        op.f("ix_user_audit_logs_status"), "user_audit_logs", ["status"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "control_holder",
                "exempt_dealer",
                name="clientannualfilingtype",
            ),
            nullable=False,
        ),
        sa.Column(
            "form_type",
            sa.Enum("1301", "1214", "1215", name="primaryannualreportform"),
            nullable=False,
        ),
        sa.Column(
            "status",
        ...
        sa.Column(
            "deadline_type",
            sa.Enum("standard", "extended", "custom", name="filingdeadlinetype"),
            nullable=False,
        ),
        ...
        sa.Column(
            "assessment_amount", sa.Numeric(precision=14, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "submission_method",
            sa.Enum("online", "manual", "representative", name="submissionmethod"),
            nullable=True,
        ),
        sa.Column(
            "extension_reason",
    ...
    op.create_index(
        "idx_annual_report_assigned", "annual_reports", ["assigned_to"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_annual_report_deadline",
        "annual_reports",
        ["filing_deadline"],
        unique=False,
    )
    op.create_index(
        "idx_annual_report_status", "annual_reports", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_annual_reports_client_record_id"),
        "annual_reports",
        ["client_record_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_annual_reports_tax_calendar_entry_id"),
        "annual_reports",
    ...
    op.create_index(
        "idx_authority_contact_type",
        "authority_contacts",
        ["contact_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_authority_contacts_client_record_id"),
        "authority_contacts",
        ["client_record_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_binder_handovers_client_record_id"),
        "binder_handovers",
        ["client_record_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_binder_period_start", "binders", ["period_start"], unique=False
    )
    op.create_index("idx_binder_status", "binders", ["status"], unique=False)
    op.create_index(
        op.f("ix_binders_client_record_id"),
        "binders",
        ["client_record_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "total_output_vat", sa.Numeric(precision=12, scale=2), nullable=False
        ),
        ...
        sa.Column(
            "total_output_net", sa.Numeric(precision=12, scale=2), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_vat_work_items_client_record_id"),
        "vat_work_items",
        ["client_record_id"],
        unique=False,
    )
    op.create_index(
        "ix_vat_work_items_period", "vat_work_items", ["period"], unique=False
    )
    op.create_index(
        "ix_vat_work_items_status", "vat_work_items", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_vat_work_items_tax_calendar_entry_id"),
        "vat_work_items",
        ["tax_calendar_entry_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "paid", "partial", name="advancepaymentstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_advance_payment_client_record_period",
        "advance_payments",
        ["client_record_id", "period"],
        unique=False,
    )
    op.create_index(
        "idx_advance_payment_due_date", "advance_payments", ["due_date"], unique=False
    )
    op.create_index(
        "idx_advance_payment_status", "advance_payments", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_advance_payments_annual_report_id"),
        "advance_payments",
        ["annual_report_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_advance_payments_client_record_id"),
        "advance_payments",
        ["client_record_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["annual_report_id"], ["annual_reports.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "annual_report_id", "reason", name="uq_credit_point_report_reason"
        ),
    )
    op.create_index(
        op.f("ix_annual_report_credit_points_annual_report_id"),
        "annual_report_credit_points",
        ["annual_report_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "pension_contribution", sa.Numeric(precision=12, scale=2), nullable=True
        ),
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
            ["report_id"], ["annual_reports.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_annual_report_income_lines_annual_report_id"),
        "annual_report_income_lines",
        ["annual_report_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_annual_report_schedules_annual_report_id"),
        "annual_report_schedules",
        ["annual_report_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_annual_report_status_history_annual_report_id"),
        "annual_report_status_history",
        ["annual_report_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["handover_id"], ["binder_handovers.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "idx_handover_binder_unique",
        "binder_handover_binders",
        ["handover_id", "binder_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_binder_handover_binders_binder_id"),
        "binder_handover_binders",
        ["binder_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_binder_handover_binders_handover_id"),
        "binder_handover_binders",
        ["handover_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_binder_intakes_binder_id"),
        "binder_intakes",
        ["binder_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_binder_status_logs_binder_id"),
        "binder_status_logs",
        ["binder_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_charge_client_record_period",
        "charges",
        ["client_record_id", "period"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_charges_annual_report_id"),
        "charges",
        ["annual_report_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_charges_business_id"), "charges", ["business_id"], unique=False
    )
    op.create_index(
        op.f("ix_charges_client_record_id"),
        "charges",
        ["client_record_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "correspondence_type",
            sa.Enum(
                "call", "letter", "email", "meeting", "fax", name="correspondencetype"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_correspondence_business_occurred",
        "correspondence_entries",
        ["business_id", "occurred_at"],
        unique=False,
    )
    op.create_index(
        "idx_correspondence_occurred",
        "correspondence_entries",
        ["occurred_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_correspondence_entries_business_id"),
        "correspondence_entries",
        ["business_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_correspondence_entries_client_record_id"),
        "correspondence_entries",
        ["client_record_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_correspondence_entries_contact_id"),
        "correspondence_entries",
        ["contact_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum(
                "info", "warning", "urgent", "critical", name="notificationseverity"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_notification_business_status",
        "notifications",
        ["business_id", "status"],
        unique=False,
    )
    op.create_index(
        "idx_notification_client_record_status",
        "notifications",
        ["client_record_id", "status"],
        unique=False,
    )
    op.create_index(
        "idx_notification_created_at", "notifications", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_notifications_annual_report_id"),
        "notifications",
        ["annual_report_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notifications_binder_id"), "notifications", ["binder_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_notifications_client_record_id"),
        "notifications",
        ["client_record_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("business_id", sa.Integer(), nullable=True),
        sa.Column(
            "scope", sa.Enum("client", "business", name="documentscope"), nullable=False
        ),
        sa.Column(
            "document_type",
            sa.Enum(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending", "received", "approved", "rejected", name="documentstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_permanent_documents_business_id"),
        "permanent_documents",
        ["business_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_permanent_documents_client_record_id"),
        "permanent_documents",
        ["client_record_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_permanent_documents_tax_year"),
        "permanent_documents",
        ["tax_year"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["work_item_id"], ["vat_work_items.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "work_item_id",
    ...
    op.create_index(
        op.f("ix_vat_invoices_business_activity_id"),
        "vat_invoices",
        ["business_activity_id"],
        unique=False,
    )
    op.create_index(
        "ix_vat_invoices_date", "vat_invoices", ["invoice_date"], unique=False
    )
    op.create_index(
        op.f("ix_vat_invoices_work_item_id"),
        "vat_invoices",
        ["work_item_id"],
        unique=False,
    )
    op.create_index(
        "ix_vat_invoices_work_item_type",
        "vat_invoices",
        ["work_item_id", "invoice_type"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
            ["schedule_entry_id"], ["annual_report_schedules.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "schedule_entry_id",
    ...
    op.create_index(
        op.f("ix_annual_report_annex_data_schedule_entry_id"),
        "annual_report_annex_data",
        ["schedule_entry_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_annual_report_expense_lines_annual_report_id"),
        "annual_report_expense_lines",
        ["annual_report_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_annual_report_expense_lines_supporting_document_id"),
        "annual_report_expense_lines",
        ["supporting_document_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_binder_intake_edit_logs_intake_id"),
        "binder_intake_edit_logs",
        ["intake_id"],
        unique=False,
    )
    op.create_table(
        "binder_intake_materials",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("intake_id", sa.Integer(), nullable=False),
        sa.Column("business_id", sa.Integer(), nullable=True),
        sa.Column(
    ...
    op.create_index(
        "idx_intake_material_business",
        "binder_intake_materials",
        ["business_id"],
        unique=False,
    )
    op.create_index(
        "idx_intake_material_type",
        "binder_intake_materials",
        ["material_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_binder_intake_materials_annual_report_id"),
        "binder_intake_materials",
        ["annual_report_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_binder_intake_materials_business_id"),
        "binder_intake_materials",
        ["business_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_binder_intake_materials_intake_id"),
        "binder_intake_materials",
        ["intake_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_binder_intake_materials_vat_report_id"),
        "binder_intake_materials",
        ["vat_report_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_invoices_charge_id"), "invoices", ["charge_id"], unique=True
    )
    op.create_table(
        "signature_requests",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        "idx_sig_request_annual_report",
        "signature_requests",
        ["annual_report_id"],
        unique=False,
    )
    op.create_index(
        "idx_sig_request_business", "signature_requests", ["business_id"], unique=False
    )
    op.create_index(
        "idx_sig_request_client_record",
        "signature_requests",
        ["client_record_id"],
        unique=False,
    )
    op.create_index(
        "idx_sig_request_status", "signature_requests", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_signature_requests_annual_report_id"),
        "signature_requests",
        ["annual_report_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_signature_requests_business_id"),
        "signature_requests",
        ["business_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_signature_requests_client_record_id"),
        "signature_requests",
        ["client_record_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("performed_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["invoice_id"], ["vat_invoices.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["performed_by"],
            ["users.id"],
    ...
    op.create_index(
        op.f("ix_vat_audit_logs_invoice_id"),
        "vat_audit_logs",
        ["invoice_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_vat_audit_logs_work_item_id"),
        "vat_audit_logs",
        ["work_item_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_sig_audit_occurred",
        "signature_audit_events",
        ["occurred_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_signature_audit_events_signature_request_id"),
        "signature_audit_events",
        ["signature_request_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_signature_audit_events_signature_request_id"),
        table_name="signature_audit_events",
    )
    ...
    op.drop_index(
        op.f("ix_signature_requests_client_record_id"), table_name="signature_requests"
    )
    op.drop_index(
        op.f("ix_signature_requests_business_id"), table_name="signature_requests"
    )
    op.drop_index(
        op.f("ix_signature_requests_annual_report_id"), table_name="signature_requests"
    )
    ...
    op.drop_index(
        op.f("ix_binder_intake_materials_vat_report_id"),
        table_name="binder_intake_materials",
    )
    op.drop_index(
        op.f("ix_binder_intake_materials_intake_id"),
        table_name="binder_intake_materials",
    ...
    op.drop_index(
        op.f("ix_binder_intake_edit_logs_intake_id"),
        table_name="binder_intake_edit_logs",
    )
    ...
    op.drop_index(
        op.f("ix_vat_invoices_business_activity_id"), table_name="vat_invoices"
    )
    op.drop_table("vat_invoices")
    op.drop_index(
        op.f("ix_permanent_documents_tax_year"), table_name="permanent_documents"
    )
    op.drop_index(
        "ix_permanent_documents_client_record_type_year",
        table_name="permanent_documents",
    )
    op.drop_index(
        op.f("ix_permanent_documents_client_record_id"),
        table_name="permanent_documents",
    ...
    op.drop_index(
        op.f("ix_permanent_documents_business_id"), table_name="permanent_documents"
    )
    ...
    op.drop_index(
        op.f("ix_correspondence_entries_contact_id"),
        table_name="correspondence_entries",
    )
    op.drop_index(
        op.f("ix_correspondence_entries_client_record_id"),
        table_name="correspondence_entries",
    ...
    op.drop_index(
        "idx_correspondence_business_occurred", table_name="correspondence_entries"
    )
    ...
    op.drop_index(
        op.f("ix_binder_status_logs_binder_id"), table_name="binder_status_logs"
    )
    ...
    op.drop_index(
        op.f("ix_binder_handover_binders_handover_id"),
        table_name="binder_handover_binders",
    )
    op.drop_index(
        op.f("ix_binder_handover_binders_binder_id"),
        table_name="binder_handover_binders",
    ...
    op.drop_index(
        op.f("ix_advance_payments_client_record_id"), table_name="advance_payments"
    )
    op.drop_index(
        op.f("ix_advance_payments_annual_report_id"), table_name="advance_payments"
    )
    ...
    op.drop_index(
        "idx_advance_payment_client_record_period", table_name="advance_payments"
    )
    ...
    op.drop_index(
        op.f("ix_vat_work_items_tax_calendar_entry_id"), table_name="vat_work_items"
    )
    ...
    op.drop_index(
        op.f("ix_vat_work_items_client_record_id"), table_name="vat_work_items"
    )
    ...
    op.drop_index(
        op.f("ix_binder_handovers_client_record_id"), table_name="binder_handovers"
    )
    op.drop_table("binder_handovers")
    op.drop_index(
        op.f("ix_authority_contacts_client_record_id"), table_name="authority_contacts"
    )
    op.drop_index("idx_authority_contact_type", table_name="authority_contacts")
    op.drop_table("authority_contacts")
    op.drop_index(
        op.f("ix_annual_reports_tax_calendar_entry_id"), table_name="annual_reports"
    )
    op.drop_index(
        op.f("ix_annual_reports_client_record_id"), table_name="annual_reports"
    )
    ...
    op.drop_index(
        op.f("ix_tax_calendar_entries_due_date"), table_name="tax_calendar_entries"
    )
    op.drop_index(
        op.f("ix_tax_calendar_entries_deadline_rule_id"),
        table_name="tax_calendar_entries",
    ...
    op.drop_index(
        "ix_person_legal_entity_links_legal_entity_id",
        table_name="person_legal_entity_links",
    )
    ...
    op.drop_index(
        op.f("ix_entity_audit_logs_entity_type"), table_name="entity_audit_logs"
    )
    op.drop_index(
        op.f("ix_entity_audit_logs_entity_id"), table_name="entity_audit_logs"
    )
    ...
    op.drop_index(
        op.f("ix_client_records_legal_entity_id"), table_name="client_records"
    )
