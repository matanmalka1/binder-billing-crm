...
Revision ID: fc1eacc58833
Revises: 
Create Date: 2026-05-10 10:33:01.766025
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('not_started', 'collecting_docs', 'docs_complete', 'in_preparation', 'pending_client', 'submitted', 'amended', 'accepted', 'assessment_issued', 'objection_filed', 'closed', 'canceled', name='annualreportstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('in_office', 'closed_in_office', 'archived_in_office', 'ready_for_pickup', 'returned', name='binderstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending_materials', 'material_received', 'data_entry_in_progress', 'ready_for_review', 'filed', 'canceled', 'archived', name='vatworkitemstatus'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('annual_report_id', sa.Integer(), nullable=False),
    sa.Column('from_status', sa.Enum('not_started', 'collecting_docs', 'docs_complete', 'in_preparation', 'pending_client', 'submitted', 'amended', 'accepted', 'assessment_issued', 'objection_filed', 'closed', 'canceled', name='annualreportstatus'), nullable=True),
    sa.Column('to_status', sa.Enum('not_started', 'collecting_docs', 'docs_complete', 'in_preparation', 'pending_client', 'submitted', 'amended', 'accepted', 'assessment_issued', 'objection_filed', 'closed', 'canceled', name='annualreportstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('draft', 'pending_signature', 'signed', 'declined', 'expired', 'canceled', name='signaturerequeststatus'), nullable=False),
