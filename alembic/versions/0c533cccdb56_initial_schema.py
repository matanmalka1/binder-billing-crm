...
def upgrade() -> None:
    ...
    op.create_index('idx_annual_report_client_year', 'annual_reports', ['client_id', 'tax_year'], unique=True, postgresql_where=sa.text('deleted_at IS NULL'))
    ...
    op.create_index('uq_vat_work_item_client_period', 'vat_work_items', ['client_id', 'period'], unique=True, postgresql_where=sa.text('deleted_at IS NULL'))
...
def downgrade() -> None:
    ...
    op.drop_index('uq_vat_work_item_client_period', table_name='vat_work_items', postgresql_where=sa.text('deleted_at IS NULL'))
    ...
    op.drop_index('idx_annual_report_client_year', table_name='annual_reports', postgresql_where=sa.text('deleted_at IS NULL'))
