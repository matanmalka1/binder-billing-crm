...
Revision ID: bce6996cfcd8
Revises: 
Create Date: 2026-04-19 18:42:19.377277
...
def upgrade() -> None:
    ...
    op.create_index('ix_clients_office_client_number_active', 'clients', ['office_client_number'], unique=True, postgresql_where=sa.text('deleted_at IS NULL'), sqlite_where=sa.text('deleted_at IS NULL'))
    ...
    op.create_index('idx_annual_report_client_year_type', 'annual_reports', ['client_id', 'tax_year'], unique=True, postgresql_where=sa.text('deleted_at IS NULL'), sqlite_where=sa.text('deleted_at IS NULL'))
    ...
    op.create_index(op.f('ix_annual_reports_client_id'), 'annual_reports', ['client_id'], unique=False)
    ...
    op.create_index('idx_authority_contact_client', 'authority_contacts', ['client_id'], unique=False)
    op.create_index('idx_authority_contact_type', 'authority_contacts', ['contact_type'], unique=False)
    op.create_index(op.f('ix_authority_contacts_client_id'), 'authority_contacts', ['client_id'], unique=False)
    ...
    op.create_index(op.f('ix_binder_handovers_client_id'), 'binder_handovers', ['client_id'], unique=False)
    ...
    sa.Column('status', app.utils.enum_utils._NormalizedEnum('in_office', 'closed_in_office', 'ready_for_pickup', 'returned', name='binderstatus'), nullable=False),
    ...
    op.create_index('idx_active_binder_unique', 'binders', ['binder_number'], unique=True, postgresql_where=sa.text("status = 'in_office' AND deleted_at IS NULL"), sqlite_where=sa.text("status = 'in_office' AND deleted_at IS NULL"))
    ...
    op.create_index(op.f('ix_vat_work_items_client_id'), 'vat_work_items', ['client_id'], unique=False)
    ...
    op.create_index('uq_vat_work_item_client_period', 'vat_work_items', ['client_id', 'period'], unique=True, postgresql_where=sa.text('deleted_at IS NULL'), sqlite_where=sa.text('deleted_at IS NULL'))
    ...
    op.create_index(op.f('ix_advance_payments_client_id'), 'advance_payments', ['client_id'], unique=False)
    ...
    op.create_index('idx_notification_client_status', 'notifications', ['client_id', 'status'], unique=False)
    ...
    op.create_index('idx_tax_deadline_client_period', 'tax_deadlines', ['client_id', 'period'], unique=False)
    ...
    op.create_index(op.f('ix_tax_deadlines_client_id'), 'tax_deadlines', ['client_id'], unique=False)
    ...
    op.create_index('idx_reminder_client_type', 'reminders', ['client_id', 'reminder_type'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_reminder_client_type', table_name='reminders')
    ...
    op.drop_index(op.f('ix_tax_deadlines_client_id'), table_name='tax_deadlines')
    ...
    op.drop_index('idx_notification_client_status', table_name='notifications')
    ...
    op.drop_index('uq_vat_work_item_client_period', table_name='vat_work_items', postgresql_where=sa.text('deleted_at IS NULL'), sqlite_where=sa.text('deleted_at IS NULL'))
    ...
    op.drop_index('idx_active_binder_unique', table_name='binders', postgresql_where=sa.text("status = 'in_office' AND deleted_at IS NULL"), sqlite_where=sa.text("status = 'in_office' AND deleted_at IS NULL"))
    op.drop_table('binders')
    op.drop_index(op.f('ix_binder_handovers_client_id'), table_name='binder_handovers')
    op.drop_table('binder_handovers')
    op.drop_index(op.f('ix_authority_contacts_client_id'), table_name='authority_contacts')
    op.drop_index('idx_authority_contact_type', table_name='authority_contacts')
    op.drop_index('idx_authority_contact_client', table_name='authority_contacts')
    op.drop_table('authority_contacts')
    op.drop_index(op.f('ix_annual_reports_client_id'), table_name='annual_reports')
    ...
    op.drop_index('idx_annual_report_client_year_type', table_name='annual_reports', postgresql_where=sa.text('deleted_at IS NULL'), sqlite_where=sa.text('deleted_at IS NULL'))
    ...
    op.drop_index('ix_clients_office_client_number_active', table_name='clients', postgresql_where=sa.text('deleted_at IS NULL'), sqlite_where=sa.text('deleted_at IS NULL'))
