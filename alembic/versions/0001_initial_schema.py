"""Initial schema (fresh reset)

Revision ID: ff773718d72e
Revises: None
Create Date: 2026-03-23 10:01:33.846923

Run:
- Upgrade:   APP_ENV=development ENV_FILE=.env.development python3 -m alembic upgrade ff773718d72e
- Downgrade: APP_ENV=development ENV_FILE=.env.development python3 -m alembic downgrade base

Notes:
- Fresh baseline migration after database reset.
- Supports both SQLite and PostgreSQL partial indexes via `sa.text(...)` predicates.
"""
...
def upgrade() -> None:
    ...
    # Client file management and core business entities.
    ...
    # Annual reporting domain and authority contacts.
    ...
    # Operational notifications and VAT work pipeline.
    ...
    # Payment and tax obligation tracking.
    ...
    sa.Column('credit_points', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('pension_credit_points', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('life_insurance_credit_points', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('tuition_credit_points', sa.Numeric(precision=5, scale=2), nullable=True),
    ...
    # Charge and correspondence records.
    ...
    # Document storage, VAT invoice lines, and external invoices.
    ...
    # Signature workflows and downstream reminders/deadlines/audit trail.
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    # Reverse order starts from signature audit and reminder/tax workflow tables.
    ...
    # Remove document and correspondence layers.
    ...
    # Remove annual reporting domain and core CRM/business entities.
    ...
    op.drop_index('idx_annual_report_business_year', table_name='annual_reports')
    ...
    op.drop_index('ix_business_tax_id', table_name='businesses')
    op.drop_index('ix_business_status', table_name='businesses')
    op.drop_index('ix_business_client_name_active', table_name='businesses')
    ...
    # Finally remove clients and users (root dependencies).
