...
Revision ID: 403d20069018
Revises: 
Create Date: 2026-04-13 08:54:49.764308
...
def upgrade() -> None:
    ...
    sa.Column('report_type', app.utils.enum_utils._NormalizedEnum('individual', 'self_employed', 'company', name='annualreporttype'), nullable=False),
    ...
    op.create_index('idx_annual_report_client_year_type', 'annual_reports', ['client_id', 'tax_year', 'report_type'], unique=True, postgresql_where=sa.text('deleted_at IS NULL'), sqlite_where=sa.text('deleted_at IS NULL'))
    ...
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_by', sa.Integer(), nullable=True),
    sa.CheckConstraint("(deadline_type != 'advance_payment') OR (advance_payment_id IS NOT NULL)", name='ck_tax_deadline_advance_payment_link'),
