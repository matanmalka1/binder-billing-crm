...
Revision ID: 2716d4ab300f
Revises: 
Create Date: 2026-05-28 01:03:17.541126
...
def upgrade() -> None:
    ...
    op.create_index('ix_vat_work_items_active_due_client', 'vat_work_items', ['due_date_effective', 'client_record_id'], unique=False, postgresql_where=sa.text('deleted_at IS NULL'), sqlite_where=sa.text('deleted_at IS NULL'))
    ...
    sa.Column('trigger', sa.Enum('binder_ready_for_handover', 'binder_missing_documents', 'binder_general_reminder', 'invoice_issued', 'payment_reminder', 'vat_documents_reminder', 'annual_report_documents_request', 'annual_report_client_reminder', 'signature_request_sent', 'signature_request_reminder', 'client_missing_information', 'client_documents_request', 'client_general_message', name='notificationtrigger'), nullable=False),
    ...
    op.create_index('idx_notification_triggered_by', 'notifications', ['triggered_by'], unique=False)
