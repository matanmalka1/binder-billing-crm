...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tax_calendar_entry_id"], ["tax_calendar_entries.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "reminder_type",
            sa.Enum("binder_idle", "document_missing", "custom", name="remindertype"),
            nullable=False,
        ),
        sa.Column(
            "status",
    ...
    op.create_index(
        "idx_reminder_business_type",
        "reminders",
        ["business_id", "reminder_type"],
        unique=False,
    )
    op.create_index(
        "idx_reminder_client_record_type",
        "reminders",
        ["client_record_id", "reminder_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reminders_binder_id"), "reminders", ["binder_id"], unique=False
    )
    op.create_index(
        op.f("ix_reminders_business_id"), "reminders", ["business_id"], unique=False
    )
    op.create_index(
        op.f("ix_reminders_client_record_id"),
        "reminders",
        ["client_record_id"],
        unique=False,
    )
    op.create_index(
        ...
        sqlite_where=sa.text("status != 'canceled' AND deleted_at IS NULL"),
    )
    op.create_table(
        "vat_invoices",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
