...
def upgrade() -> None:
    ...
    sa.Column('client_record_id', sa.Integer(), nullable=False),
    sa.Column('business_id', sa.Integer(), nullable=True),
    sa.Column('reminder_type', sa.Enum('binder_idle', 'document_missing', 'custom', name='remindertype'), nullable=False),
    sa.Column('status', sa.Enum('pending', 'sent', 'canceled', name='reminderstatus'), nullable=False),
