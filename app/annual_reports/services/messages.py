...
ANNUAL_REPORT_CLIENT_NOT_FOUND = "לקוח {client_id} לא נמצא"
INVALID_CLIENT_TYPE_ERROR = "סוג לקוח לא חוקי: '{client_type}'"
INVALID_REPORT_TYPE_ERROR = "סוג דוח לא חוקי: '{report_type}'"
INVALID_DEADLINE_TYPE_ERROR = "סוג מועד אחרון לא חוקי: '{deadline_type}'"
ANNUAL_REPORT_ALREADY_EXISTS = "דוח שנתי ללקוח {client_id} לשנת מס {tax_year} מסוג {report_type} כבר קיים (id={existing_id}, status={status})"
...
CLIENT_FALLBACK_NAME = "לקוח #{client_id}"
