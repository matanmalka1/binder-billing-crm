...
class VatImportService:
    ...
    def auto_populate(self, report_id: int, force: bool = False) -> dict:
        ...
        income_total = self.vat_agg_repo.sum_income_net_by_business_year(report.business_id, report.tax_year)
        expense_by_vat_cat = self.vat_agg_repo.sum_expense_net_by_business_year_grouped(
            report.business_id, report.tax_year
        )
