...
BUSINESS_CATALOG = [
    ...
    'כתר טכנולוגיות בע"מ',
    'אגם יעוץ עסקי בע"מ',
    'דגן חקלאות ומזון בע"מ',
    'שמש אנרגיה ירוקה בע"מ',
    'ים תיכון סחר בינלאומי בע"מ',
    'הר גבוה פרויקטים בע"מ',
    'שחף תחבורה ומשלוחים בע"מ',
    'עמק נדל"ן ופיתוח בע"מ',
    'כרמל ביו-מד בע"מ',
    'אשל שירותי מחשוב בע"מ',
    'תמר פרסום ומדיה בע"מ',
    'גלבוע יצור ותעשייה בע"מ',
    'נגב בנייה והנדסה בע"מ',
    'יובל ניהול נכסים בע"מ',
    'ענבר קוסמטיקה ויופי בע"מ',
    'סלע ביטוח ופיננסים בע"מ',
    'זמיר ייעוץ ארגוני בע"מ',
    'אלון אלקטרוניקה בע"מ',
    'לוטם בריאות ורפואה בע"מ',
    'מגדל תקשורת דיגיטלית בע"מ',
]
...
AUTHORITY_CONTACTS = [
    {
        "name": "אילה בן דוד",
        "office": "פקיד שומה תל אביב 1",
        "email": "ayala.bendavid@tax.demo-accounting.com",
    },
    {
        "name": "אופיר צדוק",
        "office": 'משרד מע"מ ירושלים',
        "email": "ofir.tsadok@tax.demo-accounting.com",
    },
    {
        "name": "ניב רחמים",
        "office": "ביטוח לאומי חיפה",
        "email": "niv.rahamim@btl.demo-accounting.com",
    },
    {
        "name": "מורן טל",
        "office": 'משרד מע"מ באר שבע',
        "email": "moran.tal@tax.demo-accounting.com",
    },
    {
        "name": "סיון הדר",
        "office": "פקיד שומה נתניה",
        "email": "sivan.hadar@tax.demo-accounting.com",
    },
    {
        "name": "רועי כהן",
        "office": "פקיד שומה תל אביב 4",
        "email": "roi.cohen@tax.demo-accounting.com",
    },
    {
        "name": "ורד אסולין",
        "office": "ביטוח לאומי ירושלים",
        "email": "vered.asolin@btl.demo-accounting.com",
    },
    {
        "name": "אייל מנחם",
        "office": 'משרד מע"מ פתח תקווה',
        "email": "eyal.menahem@tax.demo-accounting.com",
    },
    {
        "name": "תמר גל",
        "office": "פקיד שומה חיפה",
        "email": "tamar.gal@tax.demo-accounting.com",
    },
    {
        "name": "אסף שרון",
        "office": "ביטוח לאומי אשדוד",
        "email": "asaf.sharon@btl.demo-accounting.com",
    },
]
...
CORRESPONDENCE_SUBJECTS = [
    ...
    "בקשת אישור ניכוי מס במקור",
    "עדכון מסמכים לצורך פתיחת תיק",
    "פנייה בעניין שומה שהתקבלה",
    "תיאום הגשת ערעור מס",
    "בקשת הסדר תשלומים מרשות המסים",
    "פנייה בעניין קנס אי-הגשה במועד",
    "בירור לגבי החזר מס תלוי",
]
