...
AUTHORITY_CONTACTS = [
    ...
    {"name": "רועי כהן", "office": "פקיד שומה תל אביב 4", "email": "roi.cohen@tax.demo-accounting.com"},
    {"name": "ורד אסולין", "office": "ביטוח לאומי ירושלים", "email": "vered.asolin@btl.demo-accounting.com"},
    {"name": "אייל מנחם", "office": "משרד מע\"מ פתח תקווה", "email": "eyal.menahem@tax.demo-accounting.com"},
    {"name": "תמר גל", "office": "פקיד שומה חיפה", "email": "tamar.gal@tax.demo-accounting.com"},
    {"name": "אסף שרון", "office": "ביטוח לאומי אשדוד", "email": "asaf.sharon@btl.demo-accounting.com"},
]
