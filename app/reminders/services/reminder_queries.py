...
def get_reminders(
    ...
    *,
    ...
    items = reminder_repo.list_by_status(
        status=status_enum,
        page=page,
        page_size=page_size,
    ...
    return items, total, build_context_map(reminder_repo.db, business_repo, items)
...
def get_reminders_by_business(
    ...
    *,
    ...
    items = reminder_repo.list_by_business(
...
def get_reminders_by_client(
    ...
    *,
    ...
    client_record_id = int(
        ClientRecordRepository(reminder_repo.db).get_by_id(client_record_id).id
    )
    items = reminder_repo.list_by_client_record(
...
def get_reminder(
    reminder_repo: ReminderRepository, reminder_id: int
) -> Optional[Reminder]:
